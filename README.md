...
[![Build Status](https://github.com/luca-miniati/imc-prosperity-4-backtester/workflows/Build/badge.svg)](https://github.com/luca-miniati/imc-prosperity-4-backtester/actions/workflows/build.yml)
[![PyPI Version](https://img.shields.io/pypi/v/prosperity4bt)](https://pypi.org/project/prosperity4bt/)

This repository contains a backtester [IMC Prosperity 4](https://prosperity.imc.com/) algorithms, based on [my backtester for Prosperity 2](https://github.com/luca-miniati/imc-prosperity-2-backtester). The output it generates closely matches the format of the output generated by the official submission environment and is therefore compatible with my [Prosperity 4 Visualizer](https://github.com/luca-miniati/imc-prosperity-4-visualizer) (assuming your code contains the visualizer's required prerequisites as explained on the visualizer's homepage).
...
# Requires the value passed to `--data` to be a path to a directory that is similar in structure to https://github.com/luca-miniati/imc-prosperity-4-backtester/tree/master/prosperity4bt/resources
